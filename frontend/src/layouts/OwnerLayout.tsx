...
import {
  ...
  Zap, LogOut, Building2, ChevronRight, UserCircle, Menu, X
} from 'lucide-react';
        ...
        <header className="h-16 bg-white border-b border-slate-200/80 px-4 sm:px-6 lg:px-8 flex items-center justify-between sticky top-0 z-20 shadow-2xs">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 text-xs sm:text-sm text-slate-500 font-medium truncate">
              <span className="hidden sm:inline">Brand Owner</span>
          ...
          <div className="flex items-center gap-2">
            <span className="text-[11px] sm:text-xs bg-sky-50 text-sky-700 px-2.5 py-1 rounded-full font-semibold border border-sky-200 whitespace-nowrap">
              Phase 1 MVP
            </span>
          </div>
        </header>
